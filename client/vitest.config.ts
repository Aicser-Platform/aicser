...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'ee/src/ee/components/decision/**/*.test.tsx',
      'ee/src/ee/app/\\(dashboard\\)/chat/utils/**/*.test.ts',
      'ee/src/ee/app/\\(dashboard\\)/chat/components/ChatPanel/**/*.test.ts',
      'ee/src/ee/app/\\(dashboard\\)/chat/components/ChatPanel/**/*.test.tsx',
      'ee/src/ee/app/\\(dashboard\\)/report/**/*.test.ts',
